        ...
        >
          ...
          <div className="grid sm:grid-cols-3 gap-6 max-w-2xl mx-auto">
            <div className="text-center">
              <div className="text-2xl font-bold text-[hsl(var(--wf-foreground))] mb-1">30 min</div>
              <div className="text-sm text-[hsl(var(--wf-muted-foreground))]">Demo prezentacija</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-[hsl(var(--wf-foreground))] mb-1">0 €</div>
              <div className="text-sm text-[hsl(var(--wf-muted-foreground))]">Bez obaveze</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-[hsl(var(--wf-foreground))] mb-1">24h</div>
              <div className="text-sm text-[hsl(var(--wf-muted-foreground))]">Odgovor na upit</div>
            </div>
          </div>
        </motion.div>
      </div>
